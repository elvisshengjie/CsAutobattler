...
public sealed class WeaponDefinition : ScriptableObject
{
    ...
    [Header("Agent Durability")]
    public float agentHealth = 130f;
...
public static class WeaponDefaults
{
        ...
        switch (type)
        {
            case WeaponType.Rifle:
                Set(definition, 10f, 0.8f, 2f, 14f, 78f, 8f, 20f, 1f, 5f,
                    "Balanced weapon. Reliable in most situations.", 10, 2.2f);
                definition.agentHealth = 130f;
                break;
            case WeaponType.SMG:
                Set(definition, 6f, 0.55f, 0f, 8f, 68f, 15f, 20f, 1.15f, 2.5f,
                    ...
                    12, 1.5f, 3, 0.1f);
                definition.agentHealth = 120f;
                break;
            case WeaponType.Sniper:
                Set(definition, 32f, 2.8f, 6f, 25f, 92f, 3f, 30f, 0.85f, 9f,
                    "Very high long-range damage and precision, balanced by a long reload time.", 2, 2.8f);
                definition.agentHealth = 100f;
                break;
            case WeaponType.Shotgun:
                Set(definition, 7f, 1.35f, 0f, 5f, 58f, 20f, 16f, 0.95f, 2f,
                    ...
                    3, 2.4f, 1, 0.1f, 8, 0.15f);
                definition.agentHealth = 140f;
                break;
        }
    ...
    private static void Set(WeaponDefinition d, float damage, float cooldown,
        ...
        int magazineSize = 30, float reloadTime = 2f,
        ...
        int projectilesPerShot = 1, float minimumDamageMultiplier = 1f)
    {
        ...
        d.magazineSize = magazineSize; d.reloadTime = reloadTime;
